...
class InfarctClassifier:
    def __init__(self, net, max_epochs):
        """
        The classifier for infarct used for training and launching predictions
        Args:
    ...
    def _run_epoch(self, train_loader: DataLoader, valid_loader: DataLoader,
        ...
        print("The size of image is: ", last_images.shape)
        print("last_targets is: ", last_targets)
        print("last_preds is: ", last_preds)
